...
```bash
cd /Users/haole/dev/obsidian-habit-tracker
npm run build
cp -v main.js styles.css "/Users/haole/Library/Mobile Documents/iCloud~md~obsidian/Documents/Obsidian Vault/.obsidian/plugins/obsidian-checklist/"
```
